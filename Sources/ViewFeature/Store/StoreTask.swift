...
/// by the store's task management system on the **MainActor**. All task operations
/// execute on MainActor, ensuring thread-safe state access.
///
/// This is an internal type wrapped by ``ActionTask`` for public API.
///
/// ## Topics
/// ### Task Cases
/// - ``none``
